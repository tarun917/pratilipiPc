...
urlpatterns = router.urls + [
    ...
    # Unfollow (DELETE) without needing follow-id
    path('users/<int:user_pk>/follow/remove/', FollowViewSet.as_view({'delete': 'remove'}), name='follow-remove'),
